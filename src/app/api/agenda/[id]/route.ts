...
// PATCH /api/agenda/[id] — edita a operadora da frente Agenda Aberta.
// Body: { name?, briefing?, ccEmails?, notes?, contactName?, email?, phone? }
...
// DELETE /api/agenda/[id] — remove a operadora da frente (cascade nos filhos).
